                    ...
                    <div class="card-body">
                        <div class="p-2" style="font-size: 17px">
                            ...
                            <div class="row py-3 m-1 justify-content-center">
                                ...
                                <form>
                                    <a href="{{ route('car_index') }}" class="form-control btn btn-primary" style="background-color: #2D2A4A">แก้ไขปฏิทิน</a>
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-8">
                <div class="card">
                    <div class="card-header text-white text-center" style="background-color: #2D2A4A">
                        รายการยื่นขอรับพิจารณาโครงการวิจัย
                        <a href="{{ route('project_index') }}" class="btn btn-primary btn-sm float-right" style="background-color:#A51931; border-color: #A51931;">ดูทั้งหมด</a>
                    </div>
                    <div class="card-body">
